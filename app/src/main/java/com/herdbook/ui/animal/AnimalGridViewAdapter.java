...
public class AnimalGridViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AnimalGridViewAdapter(Context context, int sectionResourceId, int textResourceId,RecyclerView recyclerView,
